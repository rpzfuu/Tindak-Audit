    ...
    <dialog ref="modal" class="modal">
        ...
        >
            <v-icon
                ...
                scale="4"
            ></v-icon>
            <h3 class="mb-2 text-2xl font-extrabold text-secondary">
                Kirim Temuan
            </h3>
            <p class="mb-4 text-gray-600 text-md">
                Apakah anda yakin ingin kirim temuan ini?
            </p>
            ...
            <div class="flex justify-center space-x-4 modal-action">
                <form @submit.prevent="kirimTemuan" class="flex-1">
                    <button
                        class="w-full px-6 py-2 text-white btn btn-secondary"
                    >
                        Ya, Kirim!
                    </button>
                </form>
